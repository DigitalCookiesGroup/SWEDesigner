	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="params.rawparams.html">RawParams</a>
				</li>
			</ul>
			<h1>Interface RawParams</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					...
					<p>An object containing state parameter key/value pairs</p>
					<h4 id="example-">Example:</h4>
					<pre><code class="lang-js">{
  <span class="hljs-attr">userId</span>: <span class="hljs-number">353474</span>,
  <span class="hljs-attr">folderId</span>: <span class="hljs-string">'inbox'</span>
}
</code></pre>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">RawParams</span>
					</li>
				</ul>
			</section>
