...
<head>
	...
	<title>HookTuple | @uirouter/angular</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="transition.hooktuple.html">HookTuple</a>
				</li>
			</ul>
			<h1>Interface HookTuple</h1>
		</div>
	</div>
</header>
<div class="container container-main">
	<div class="row">
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">HookTuple</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section tsd-is-not-exported">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-not-exported"><a href="transition.hooktuple.html#hook" class="tsd-kind-icon">hook</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-not-exported"><a href="transition.hooktuple.html#node" class="tsd-kind-icon">node</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-not-exported"><a href="transition.hooktuple.html#transitionhook" class="tsd-kind-icon">transition<wbr>Hook</a></li>
							</ul>
						</section>
					</div>
				</section>
        ...
        <h3>hook</h3>
    -->
					<div class="tsd-signature tsd-kind-icon">hook<span class="tsd-signature-symbol">:</span> <a href="../classes/transition.registeredhook.html" class="tsd-signature-type">RegisteredHook</a></div>
					<div class="tsd-declaration">
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/hookBuilder.ts#L119">core/src/transition/hookBuilder.ts:119</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-not-exported">
        ...
        <h3>node</h3>
    -->
					<div class="tsd-signature tsd-kind-icon">node<span class="tsd-signature-symbol">:</span> <a href="../classes/path.pathnode.html" class="tsd-signature-type">PathNode</a></div>
					<div class="tsd-declaration">
					</div>
					<aside class="tsd-sources">
						<ul>
				...
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-not-exported">
					<a name="transitionhook" class="tsd-anchor"></a>
					<!--
        <h3>transition<wbr>Hook</h3>
    -->
					<div class="tsd-signature tsd-kind-icon">transition<wbr>Hook<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">TransitionHook</span></div>
					<div class="tsd-declaration">
					</div>
					<aside class="tsd-sources">
						<ul>
					...
					<li class="current tsd-kind-interface tsd-parent-kind-external-module tsd-is-not-exported">
						...
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-not-exported">
								<a href="transition.hooktuple.html#hook" class="tsd-kind-icon">hook</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-not-exported">
								<a href="transition.hooktuple.html#node" class="tsd-kind-icon">node</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-not-exported">
								<a href="transition.hooktuple.html#transitionhook" class="tsd-kind-icon">transition<wbr>Hook</a>
							</li>
						</ul>
					</li>
				</ul>
