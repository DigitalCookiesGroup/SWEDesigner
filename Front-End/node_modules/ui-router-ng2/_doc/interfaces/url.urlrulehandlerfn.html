...
<head>
	...
	<title>UrlRuleHandlerFn | @uirouter/angular</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="url.urlrulehandlerfn.html">UrlRuleHandlerFn</a>
				</li>
			</ul>
			<h1>Interface UrlRuleHandlerFn</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Handler invoked when a rule is matched</p>
					</div>
					<p>The matched value from the rule&#39;s <a href="url.urlrulematchfn.html">UrlRuleMatchFn</a> is passed as the first argument
					The handler should return a string (to redirect), a <a href="../classes/state.targetstate.html">TargetState</a>/<a href="state.targetstatedef.html">TargetStateDef</a>, or void</p>
					<p>If the handler returns a string, the url is replaced with the string.
					If the handler returns a <a href="../classes/state.targetstate.html">TargetState</a>, the target state is activated.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">UrlRuleHandlerFn</span>
					</li>
				</ul>
			</section>
			<section class="tsd-panel">
				...
				<ul class="tsd-signatures tsd-kind-interface tsd-parent-kind-external-module">
					<li class="tsd-signature tsd-kind-icon">__call<span class="tsd-signature-symbol">(</span>matchValue<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">any</span>, url<span class="tsd-signature-symbol">?: </span><a href="url.urlparts.html" class="tsd-signature-type">UrlParts</a>, router<span class="tsd-signature-symbol">?: </span><a href="../classes/core.uirouter.html" class="tsd-signature-type">UIRouter</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol"> | </span><a href="../classes/state.targetstate.html" class="tsd-signature-type">TargetState</a><span class="tsd-signature-symbol"> | </span><a href="state.targetstatedef.html" class="tsd-signature-type">TargetStateDef</a></li>
					<li class="tsd-header">
						<p> Handler invoked when a rule is matched </p>
					</li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<ul class="tsd-parameters">
							<li>
								<h5>matchValue: <span class="tsd-flag ts-flagOptional">Optional</span>&nbsp; <span class="tsd-signature-type">any</span></h5>
							</li>
							<li>
						...
						<div class="tsd-returns">
							<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">string</span>
								...
								<span class="tsd-signature-symbol"> | </span>
								<a href="../classes/state.targetstate.html" class="tsd-signature-type">TargetState</a>
								<span class="tsd-signature-symbol"> | </span>
								<a href="state.targetstatedef.html" class="tsd-signature-type">TargetStateDef</a>
							</h4>
						</div>
						<hr>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/interface.ts#L461">core/src/url/interface.ts:461</a></li>
							</ul>
					</aside>        </li>
				</ul>
			</section>
