...
<head>
	...
	<title>IHookRegistry | @uirouter/angular</title>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<pre><code><span class="hljs-meta">$</span><span class="bash">transitions.getHooks(<span class="hljs-string">"onEnter"</span>)</span>
</code></pre>
							</div>
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L696">core/src/transition/interface.ts:696</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
...
$transitions.onBefore( { <span class="hljs-attr">to</span>: <span class="hljs-string">'requireauth.**'</span> }, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">trans</span>) </span>{
  ...
  <span class="hljs-keyword">return</span> myAuthService.isAuthenticated();
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L369">core/src/transition/interface.ts:369</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
...
<span class="hljs-variable">$transitions</span>.<span class="hljs-keyword">on</span>Enter({ entering: 'admin' }, function(transition, <span class="hljs-keyword">state</span>) {
  ...
  <span class="hljs-keyword">on</span>Enter: function(<span class="hljs-variable">$transition</span>$, <span class="hljs-variable">$state</span>$) {
    ...
    AuditService.<span class="hljs-keyword">log</span>(<span class="hljs-string">"Entered "</span> + <span class="hljs-keyword">state</span>.name + <span class="hljs-string">" module while transitioning to "</span> + transition.<span class="hljs-keyword">to</span>().name);
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L510">core/src/transition/interface.ts:510</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L686">core/src/transition/interface.ts:686</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L588">core/src/transition/interface.ts:588</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L616">core/src/transition/interface.ts:616</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L548">core/src/transition/interface.ts:548</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
  ...
  <span class="hljs-keyword">if</span> (!MyAuthService.isAuthenticated()) {
    ...
    <span class="hljs-keyword">return</span> MyAuthService.authenticate().catch(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
      ...
      <span class="hljs-keyword">return</span> $state.target(<span class="hljs-string">"guest"</span>);
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L438">core/src/transition/interface.ts:438</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L643">core/src/transition/interface.ts:643</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
