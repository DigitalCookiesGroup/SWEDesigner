...
<head>
	...
	<title>ResolvableLiteral | @uirouter/angular</title>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					...
					<p>These objects may be used in the <a href="state.statedeclaration.html#resolve">StateDeclaration.resolve</a> array to declare
...
<span class="hljs-keyword">var</span> state = {
  ...
  <span class="hljs-attr">resolve</span>: [
    { <span class="hljs-attr">token</span>: <span class="hljs-string">'myData'</span>, <span class="hljs-attr">deps</span>: [MyDataApi], <span class="hljs-attr">resolveFn</span>: <span class="hljs-function">(<span class="hljs-params">myDataApi</span>) =&gt;</span> myDataApi.getData() },
  ],
}
</code></pre>
				</div>
    ...
    -->
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/resolve/interface.ts#L84">core/src/resolve/interface.ts:84</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">deps<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span>    <div class="tsd-header">
							<p> The Dependency Injection tokens </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>This is an array of Dependency Injection tokens for the dependencies of the <a href="resolve.resolvableliteral.html#resolvefn">resolveFn</a>.</p>
							<p>The DI tokens are references to other <code>Resolvables</code>, or to other
							services from the native DI system.</p>
						</div>
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/resolve/interface.ts#L81">core/src/resolve/interface.ts:81</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">policy<span class="tsd-signature-symbol">:</span> <a href="resolve.resolvepolicy.html" class="tsd-signature-type">ResolvePolicy</a>    <div class="tsd-header">
							<p> Defines the Resolve Policy </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>A policy that defines when to invoke the resolve,
							and whether to wait for async and unwrap the data</p>
						</div>
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/resolve/interface.ts#L71">core/src/resolve/interface.ts:71</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">resolve<wbr>Fn<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Function</span>    <div class="tsd-header">
							<p> A function which fetches the Resolvable&#39;s data </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>A function which returns one of:</p>
							<ul>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/resolve/interface.ts#L63">core/src/resolve/interface.ts:63</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">token<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span>    <div class="tsd-header">
							<p> A Dependency Injection token </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>This Resolvable&#39;s DI token.
							The Resolvable will be injectable elsewhere using the token.</p>
						</div>
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/resolve/interface.ts#L49">core/src/resolve/interface.ts:49</a></li>
						</ul>
					</aside>
				</section>
			</section>
