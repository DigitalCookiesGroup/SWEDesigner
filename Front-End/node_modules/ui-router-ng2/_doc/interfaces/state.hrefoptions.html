...
<head>
	...
	<title>HrefOptions | @uirouter/angular</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="state.hrefoptions.html">HrefOptions</a>
				</li>
			</ul>
			<h1>Interface HrefOptions</h1>
		</div>
	</div>
</header>
<div class="container container-main">
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>An options object for <a href="../classes/state.stateservice.html#href">StateService.href</a></p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">HrefOptions</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="state.hrefoptions.html#absolute" class="tsd-kind-icon">absolute</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="state.hrefoptions.html#inherit" class="tsd-kind-icon">inherit</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="state.hrefoptions.html#lossy" class="tsd-kind-icon">lossy</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="state.hrefoptions.html#relative" class="tsd-kind-icon">relative</a></li>
							</ul>
						</section>
					</div>
				</section>
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">absolute<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">boolean</span>    <div class="tsd-header">
							<p> If true will generate an absolute url, e.g. <code>http://www.example.com/fullurl</code>. </p>
						</div>
					</div>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L745">core/src/state/interface.ts:745</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">inherit<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">boolean</span>    <div class="tsd-header">
							<p> If <code>true</code> will inherit parameters from the current parameter values. </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L740">core/src/state/interface.ts:740</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
					<a name="lossy" class="tsd-anchor"></a>
					<!--
        <h3><span class="tsd-flag ts-flagOptional">Optional</span> lossy</h3>
    -->
					<div class="tsd-signature tsd-kind-icon">lossy<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">boolean</span>    <div class="tsd-header">
							<p> If true, and if there is no url associated with the state provided in the
								first parameter, then the constructed href url will be built from the first
							ancestor which has a url. </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L735">core/src/state/interface.ts:735</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">relative<span class="tsd-signature-symbol">:</span> <a href="../modules/state.html#stateorname" class="tsd-signature-type">StateOrName</a>    <div class="tsd-header">
							<p> Defines what state to be &quot;relative from&quot; </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>When a relative path is found (e.g <code>^</code> or <code>.bar</code>), defines which state to be relative from.</p>
						</div>
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L728">core/src/state/interface.ts:728</a></li>
						</ul>
					</aside>
				</section>
			</section>
					...
					<li class="current tsd-kind-interface tsd-parent-kind-external-module">
						...
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="state.hrefoptions.html#absolute" class="tsd-kind-icon">absolute</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="state.hrefoptions.html#inherit" class="tsd-kind-icon">inherit</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="state.hrefoptions.html#lossy" class="tsd-kind-icon">lossy</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="state.hrefoptions.html#relative" class="tsd-kind-icon">relative</a>
							</li>
						</ul>
					</li>
				</ul>
