...
<head>
	...
	<title>StateDeclaration | @uirouter/angular</title>
...
registry.register(foldersState);
					...
					<dl class="tsd-comment-tags">
						...
						<dd><p>()
								...
								name: &#39;folders&#39;,
								url: &#39;/folders&#39;,
							component: FoldersComponent</p>
							<p>  @Resolve({ deps: [ FolderService ] })
								allfolders(FolderService) {
								return FolderService.list();
								},
							}</p>
							<p>registry.register(FoldersState);
							```</p>
						</dd>
					</dl>
				</div>
    ...
    -->
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L190">core/src/state/interface.ts:190</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L155">core/src/state/interface.ts:155</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L439">core/src/state/interface.ts:439</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
...
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> lazyLoadResults;
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L698">core/src/state/interface.ts:698</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L147">core/src/state/interface.ts:147</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
  ...
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">"Entering "</span> + state.name);
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L530">core/src/state/interface.ts:530</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
  ...
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">"Leaving "</span> + state.name);
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L574">core/src/state/interface.ts:574</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
  ...
  <span class="hljs-built_in">console</span>.log(state.name + <span class="hljs-string">" is still active!"</span>);
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L552">core/src/state/interface.ts:552</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
  ...
  <span class="hljs-attr">param2</span>: {
    <span class="hljs-attr">value</span>: <span class="hljs-string">"index"</span>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L378">core/src/state/interface.ts:378</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
...
<span class="hljs-keyword">var</span> childstate = {
  ...
  <span class="hljs-comment">// parent: parentstate</span>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L181">core/src/state/interface.ts:181</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
...
.state(<span class="hljs-string">'G'</span>, {
  <span class="hljs-attr">redirectTo</span>: <span class="hljs-function">(<span class="hljs-params">trans</span>) =&gt;</span> {
    ...
    <span class="hljs-keyword">return</span> resolvePromise.then(<span class="hljs-function"><span class="hljs-params">resolveData</span> =&gt;</span> resolveData === <span class="hljs-string">'login'</span> ? <span class="hljs-string">'login'</span> : <span class="hljs-literal">null</span>);
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L506">core/src/state/interface.ts:506</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L703">core/src/state/interface.ts:703</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">resolve<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">Array</span><span class="tsd-signature-symbol">&lt;</span><a href="../classes/resolve.resolvable.html" class="tsd-signature-type">Resolvable</a><span class="tsd-signature-symbol"> | </span><a href="resolve.resolvableliteral.html" class="tsd-signature-type">ResolvableLiteral</a><span class="tsd-signature-symbol"> | </span><a href="resolve.providerlike.html" class="tsd-signature-type">ProviderLike</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">object</span>    <div class="tsd-header">
...
resolve: [
  ...
  { <span class="hljs-attr">provide</span>: <span class="hljs-string">'user'</span>, (allusers, trans) =&gt; _.find(allusers, trans.params().userId, <span class="hljs-attr">deps</span>: [<span class="hljs-string">'allusers'</span>, Transition] }
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L312">core/src/state/interface.ts:312</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L326">core/src/state/interface.ts:326</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
...
url: <span class="hljs-string">"/messages/:mailboxid?{before:date}&amp;{after:date}"</span>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L356">core/src/state/interface.ts:356</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
...
views: {
  <span class="hljs-string">'header@top'</span>: {
    ...
    <span class="hljs-attr">templateUrl</span>: <span class="hljs-string">"messages.html"</span>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L425">core/src/state/interface.ts:425</a></li>
						</ul>
					</aside>
				</section>
			</section>
