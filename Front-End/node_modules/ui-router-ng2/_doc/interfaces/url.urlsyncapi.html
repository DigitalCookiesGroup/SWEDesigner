...
<head>
	...
	<title>UrlSyncApi | @uirouter/angular</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="url.urlsyncapi.html">UrlSyncApi</a>
				</li>
			</ul>
			<h1>Interface UrlSyncApi</h1>
		</div>
	</div>
</header>
<div class="container container-main">
		...
		<div class="col-8 col-content">
			...
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">UrlSyncApi</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-method tsd-parent-kind-interface"><a href="url.urlsyncapi.html#deferintercept" class="tsd-kind-icon">defer<wbr>Intercept</a></li>
								<li class="tsd-kind-method tsd-parent-kind-interface"><a href="url.urlsyncapi.html#listen" class="tsd-kind-icon">listen</a></li>
								<li class="tsd-kind-method tsd-parent-kind-interface"><a href="url.urlsyncapi.html#sync" class="tsd-kind-icon">sync</a></li>
							</ul>
						</section>
					</div>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface">
						<li class="tsd-signature tsd-kind-icon">defer<wbr>Intercept<span class="tsd-signature-symbol">(</span>defer<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span></li>
						<li class="tsd-header">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								Once the initialization is complete, call <a href="url.urlsyncapi.html#listen">listen</a> to tell UI-Router to start watching and synchronizing the URL.</p>
...
$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  ...
  urlService.sync();
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/interface.ts#L193">core/src/url/interface.ts:193</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<p>Call this sometime after calling <a href="url.urlsyncapi.html#deferintercept">deferIntercept</a> to start monitoring the url.
								This causes <a href="../classes/url.urlrouter.html">UrlRouter</a> to start listening for changes to the URL, if it wasn&#39;t already listening.</p>
...
$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  ...
  urlService.sync();
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/interface.ts#L167">core/src/url/interface.ts:167</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface">
						...
						<li class="tsd-header">
							<p> Checks the URL for a matching <a href="url.urlrule.html">UrlRule</a> </p>
						</li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
...
$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  ...
  urlService.sync();
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/interface.ts#L145">core/src/url/interface.ts:145</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
					...
					<li class="current tsd-kind-interface tsd-parent-kind-external-module tsd-is-external">
						...
						<ul>
							<li class=" tsd-kind-method tsd-parent-kind-interface">
								<a href="url.urlsyncapi.html#deferintercept" class="tsd-kind-icon">defer<wbr>Intercept</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-interface">
								<a href="url.urlsyncapi.html#listen" class="tsd-kind-icon">listen</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-interface">
								<a href="url.urlsyncapi.html#sync" class="tsd-kind-icon">sync</a>
							</li>
						</ul>
					</li>
				</ul>
