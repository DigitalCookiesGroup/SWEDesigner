...
<head>
	...
	<title>LazyLoadResult | @uirouter/angular</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="state.lazyloadresult.html">LazyLoadResult</a>
				</li>
			</ul>
			<h1>Interface LazyLoadResult</h1>
		</div>
	</div>
</header>
<div class="container container-main">
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The return type of a <a href="state.statedeclaration.html#lazyload">StateDeclaration.lazyLoad</a> function</p>
					</div>
					<p>If your state has a <code>lazyLoad</code> function, it should return a promise.
						If promise resolves to an object matching this interface, then the <code>states</code> array
					of <a href="state.statedeclaration.html">StateDeclaration</a> objects will be automatically registered.</p>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">LazyLoadResult</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="state.lazyloadresult.html#states" class="tsd-kind-icon">states</a></li>
							</ul>
						</section>
					</div>
				</section>
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">states<span class="tsd-signature-symbol">:</span> <a href="state.statedeclaration.html" class="tsd-signature-type">StateDeclaration</a><span class="tsd-signature-symbol">[]</span></div>
					<div class="tsd-declaration">
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/state/interface.ts#L716">core/src/state/interface.ts:716</a></li>
						</ul>
					</aside>
				</section>
			</section>
					...
					<li class="current tsd-kind-interface tsd-parent-kind-external-module tsd-is-external">
						...
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="state.lazyloadresult.html#states" class="tsd-kind-icon">states</a>
							</li>
						</ul>
					</li>
				</ul>
