...
<head>
	...
	<title>ViewContext | @uirouter/angular</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="view.viewcontext.html">ViewContext</a>
				</li>
			</ul>
...
<div class="container container-main">
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The context ref can be anything that has a <code>name</code> and a <code>parent</code> reference to another IContextRef</p>
					</div>
				</div>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section tsd-is-external">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="view.viewcontext.html#name" class="tsd-kind-icon">name</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="view.viewcontext.html#parent" class="tsd-kind-icon">parent</a></li>
							</ul>
						</section>
					</div>
				</section>
    ...
    -->
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/view/interface.ts#L9">core/src/view/interface.ts:9</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
        ...
        <h3>parent</h3>
    -->
					<div class="tsd-signature tsd-kind-icon">parent<span class="tsd-signature-symbol">:</span> <a href="view.viewcontext.html" class="tsd-signature-type">ViewContext</a></div>
					<div class="tsd-declaration">
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/view/interface.ts#L10">core/src/view/interface.ts:10</a></li>
						</ul>
					</aside>
				</section>
			</section>
					...
					<li class="current tsd-kind-interface tsd-parent-kind-external-module tsd-is-external">
						...
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
								<a href="view.viewcontext.html#name" class="tsd-kind-icon">name</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
								<a href="view.viewcontext.html#parent" class="tsd-kind-icon">parent</a>
							</li>
						</ul>
					</li>
				</ul>
