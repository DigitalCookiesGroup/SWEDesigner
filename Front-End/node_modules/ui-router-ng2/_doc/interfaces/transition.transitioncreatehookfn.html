...
<head>
	...
	<title>TransitionCreateHookFn | @uirouter/angular</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="transition.transitioncreatehookfn.html">TransitionCreateHookFn</a>
				</li>
			</ul>
			<h1>Interface TransitionCreateHookFn</h1>
		</div>
	</div>
</header>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The signature for Transition onCreate Hooks.</p>
					</div>
					<p>Transition onCreate Hooks are callbacks that allow customization or preprocessing of
					a Transition before it is returned from <a href="../classes/transition.transitionservice.html#create">TransitionService.create</a></p>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">TransitionCreateHookFn</span>
					</li>
				</ul>
			</section>
			<section class="tsd-panel">
				...
				<ul class="tsd-signatures tsd-kind-interface tsd-parent-kind-external-module">
					<li class="tsd-signature tsd-kind-icon">__call<span class="tsd-signature-symbol">(</span>transition<span class="tsd-signature-symbol">: </span><a href="../classes/transition.transition-1.html" class="tsd-signature-type">Transition</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
					<li class="tsd-header">
						<p> The signature for Transition onCreate Hooks. </p>
					</li>
				</ul>
					...
					<li class="tsd-description">
						...
						<ul class="tsd-parameters">
							<li>
								...
								:         <div class="tsd-comment tsd-typography">
									<div class="lead">
										<p>the <a href="../classes/transition.transition-1.html">Transition</a> that was just created</p>
									</div>
								</div>
							</li>
						</ul>
						<div class="tsd-returns">
							...
							: <p>a <a href="../classes/transition.transition-1.html">Transition</a> which will then be returned from <a href="../classes/transition.transitionservice.html#create">TransitionService.create</a></p>
						</div>
						<hr>
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L226">core/src/transition/interface.ts:226</a></li>
							</ul>
					</aside>        </li>
				</ul>
			</section>
