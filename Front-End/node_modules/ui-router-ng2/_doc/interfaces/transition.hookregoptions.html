...
<head>
	...
	<title>HookRegOptions | @uirouter/angular</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="transition.hookregoptions.html">HookRegOptions</a>
				</li>
			</ul>
			<h1>Interface HookRegOptions</h1>
		</div>
	</div>
</header>
<div class="container container-main">
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>These options may be provided when registering a Transition Hook (such as <code>onStart</code>)</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						<span class="target">HookRegOptions</span>
					</li>
				</ul>
			</section>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="transition.hookregoptions.html#bind" class="tsd-kind-icon">bind</a></li>
								<li class="tsd-kind-property tsd-parent-kind-interface"><a href="transition.hookregoptions.html#priority" class="tsd-kind-icon">priority</a></li>
							</ul>
						</section>
					</div>
				</section>
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">bind<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span>    <div class="tsd-header">
							<p> Specifies what <code>this</code> is bound to during hook invocation. </p>
						</div>
					</div>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L264">core/src/transition/interface.ts:264</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">priority<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">number</span>    <div class="tsd-header">
							<p> Sets the priority of the registered hook </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>Hooks of the same type (onBefore, onStart, etc) are invoked in priority order.  A hook with a higher priority
							is invoked before a hook with a lower priority.</p>
							<p>The default hook priority is 0</p>
						</div>
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L259">core/src/transition/interface.ts:259</a></li>
						</ul>
					</aside>
				</section>
			</section>
					...
					<li class="current tsd-kind-interface tsd-parent-kind-external-module">
						...
						<ul>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="transition.hookregoptions.html#bind" class="tsd-kind-icon">bind</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-interface">
								<a href="transition.hookregoptions.html#priority" class="tsd-kind-icon">priority</a>
							</li>
						</ul>
					</li>
				</ul>
