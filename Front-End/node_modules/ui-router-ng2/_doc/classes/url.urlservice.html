...
<head>
	...
	<title>UrlService | @uirouter/angular</title>
...
<div class="container container-main">
	<div class="row">
					...
					<div class="tsd-index-content">
						...
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								...
								<li class="tsd-kind-method tsd-parent-kind-class"><a href="url.urlservice.html#dispose" class="tsd-kind-icon">dispose</a></li>
								...
								<li class="tsd-kind-method tsd-parent-kind-class"><a href="url.urlservice.html#onchange" class="tsd-kind-icon">on<wbr>Change</a></li>
        ...
        <h3>config</h3>
    -->
					<div class="tsd-signature tsd-kind-icon">config<span class="tsd-signature-symbol">:</span> <a href="../interfaces/url.urlconfigapi.html" class="tsd-signature-type">UrlConfigApi</a>    <div class="tsd-header">
							<p> A nested API to configure the URL and retrieve URL information </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>See: <a href="../interfaces/url.urlconfigapi.html">UrlConfigApi</a> for details</p>
						</div>
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L79">core/src/url/urlService.ts:79</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class">
        ...
        <h3>rules</h3>
    -->
					<div class="tsd-signature tsd-kind-icon">rules<span class="tsd-signature-symbol">:</span> <a href="../interfaces/url.urlrulesapi.html" class="tsd-signature-type">UrlRulesApi</a>    <div class="tsd-header">
							<p> A nested API for managing URL rules and rewrites </p>
						</div>
					</div>
					<div class="tsd-declaration">
						<div class="tsd-comment tsd-typography">
							...
							<p>See: <a href="../interfaces/url.urlrulesapi.html">UrlRulesApi</a> for details</p>
						</div>
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L72">core/src/url/urlService.ts:72</a></li>
						</ul>
					</aside>
				</section>
			</section>
...
$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  ...
  urlService.sync();
							...
							<aside class="tsd-sources">
								...
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L63">core/src/url/urlService.ts:63</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L56">core/src/url/urlService.ts:56</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								...
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L40">core/src/url/urlService.ts:40</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
...
$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  ...
  urlService.sync();
							...
							<aside class="tsd-sources">
								...
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L61">core/src/url/urlService.ts:61</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L65">core/src/url/urlService.ts:65</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
						...
						<li class="tsd-header">
							<p> Registers a url change handler </p>
						</li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<h4 id="example-">Example:</h4>
								<pre><code class="lang-js"><span class="hljs-keyword">let</span> deregisterFn = locationServices.onChange(<span class="hljs-function">(<span class="hljs-params">evt</span>) =&gt;</span> <span class="hljs-built_in">console</span>.log(<span class="hljs-string">"url change"</span>, evt));
</code></pre>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
							...
							<aside class="tsd-sources">
								...
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L42">core/src/url/urlService.ts:42</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
						...
						<li class="tsd-header">
							<p> Returns the current URL parts </p>
						</li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<p>This method returns the current URL components as a <a href="../interfaces/url.urlparts.html">UrlParts</a> object.</p>
							</div>
							<div class="tsd-returns">
								<h4 class="tsd-returns-title">Returns <a href="../interfaces/url.urlparts.html" class="tsd-signature-type">UrlParts</a></h4>
								: <p>the current url parts</p>
							</div>
							<hr>
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L52">core/src/url/urlService.ts:52</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								...
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L36">core/src/url/urlService.ts:36</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<div class="tsd-returns">
								...
								: <p>the search (querystring) portion of the url, as an object</p>
								<ul class="tsd-parameters">
							...
							<aside class="tsd-sources">
								...
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L38">core/src/url/urlService.ts:38</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
...
$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  ...
  urlService.sync();
							...
							<aside class="tsd-sources">
								...
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L59">core/src/url/urlService.ts:59</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
						...
						<li class="tsd-header">
							<p> Gets the current url string </p>
						</li>
						<li class="tsd-signature tsd-kind-icon">url<span class="tsd-signature-symbol">(</span>newurl<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, replace<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">boolean</span>, state<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
						<li class="tsd-header">
							<p> Updates the url, or gets the current url </p>
						</li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<p>The URL is normalized using the internal <a href="url.urlservice.html#path">path</a>/<a href="url.urlservice.html#search">search</a>/<a href="url.urlservice.html#hash">hash</a> values.</p>
								...
								<pre><code><span class="hljs-symbol">http:</span>/<span class="hljs-regexp">/mysite.com/somepath</span><span class="hljs-regexp">/index.html#/internal</span><span class="hljs-regexp">/path/</span><span class="hljs-number">123</span>?param1=foo<span class="hljs-comment">#anchor</span>
</code></pre><p>or</p>
								<pre><code>http:<span class="hljs-regexp">//my</span>site.com<span class="hljs-regexp">/basepath/i</span>nternal<span class="hljs-regexp">/path/</span><span class="hljs-number">123</span>?param1=foo<span class="hljs-comment">#anchor</span>
</code></pre><p>then this method returns:</p>
								<pre><code>/<span class="hljs-keyword">internal</span>/path/<span class="hljs-number">123</span>?param1=foo<span class="hljs-meta">#anchor</span>
</code></pre><h4 id="example-">Example:</h4>
								<pre><code class="lang-js">locationServices.url(); <span class="hljs-comment">// "/some/path?query=value#anchor"</span>
</code></pre>
							</div>
							<div class="tsd-returns">
								<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">string</span></h4>
								: <p>the current value of the url, as a string.</p>
							</div>
							<hr>
							<aside class="tsd-sources">
								<p>Implementation of <a href="../interfaces/common.locationservices.html">LocationServices</a>.<a href="../interfaces/common.locationservices.html#url">url</a></p>
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L31">core/src/url/urlService.ts:31</a></li>
								</ul>
						</aside>        </li>
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<p>Updates the url, changing it to the value in <code>newurl</code></p>
								<h4 id="example-">Example:</h4>
								<pre><code class="lang-js">locationServices.url(<span class="hljs-string">"/some/path?query=value#anchor"</span>, <span class="hljs-literal">true</span>);
</code></pre>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
							...
							<aside class="tsd-sources">
								<p>Implementation of <a href="../interfaces/common.locationservices.html">LocationServices</a>.<a href="../interfaces/common.locationservices.html#url">url</a></p>
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlService.ts#L33">core/src/url/urlService.ts:33</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
				...
				<ul class="current">
					<li class="current tsd-kind-class tsd-parent-kind-external-module">
						...
						<ul>
							...
							<li class=" tsd-kind-method tsd-parent-kind-class">
								<a href="url.urlservice.html#dispose" class="tsd-kind-icon">dispose</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-class">
