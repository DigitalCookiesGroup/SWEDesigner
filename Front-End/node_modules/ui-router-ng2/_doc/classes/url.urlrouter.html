...
<div class="container container-main">
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					...
					For configuring URL rules, use the <a href="../interfaces/url.urlrulesapi.html">UrlRulesApi</a> which can be found as <a href="url.urlservice.html#rules">UrlService.rules</a>.</p>
					<p>This class updates the URL when the state changes.
					It also responds to changes in the URL.</p>
				</div>
			</section>
			...
			<section class="tsd-panel">
				<h3>Implements</h3>
				<ul class="tsd-hierarchy">
					<li><a href="../interfaces/url.urlrulesapi.html" class="tsd-signature-type">UrlRulesApi</a></li>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section tsd-is-external">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#urlrulefactory" class="tsd-kind-icon">url<wbr>Rule<wbr>Factory</a></li>
							</ul>
						</section>
						<section class="tsd-index-section tsd-is-external">
							<h3>Methods</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#deferintercept" class="tsd-kind-icon">defer<wbr>Intercept</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#dispose" class="tsd-kind-icon">dispose</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-private tsd-is-external"><a href="url.urlrouter.html#ensuresorted" class="tsd-kind-icon">ensure<wbr>Sorted</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#href" class="tsd-kind-icon">href</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#initial" class="tsd-kind-icon">initial</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#listen" class="tsd-kind-icon">listen</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#match" class="tsd-kind-icon">match</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#otherwise" class="tsd-kind-icon">otherwise</a></li>
								...
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#removerule" class="tsd-kind-icon">remove<wbr>Rule</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#rule" class="tsd-kind-icon">rule</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#rules" class="tsd-kind-icon">rules</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#sort" class="tsd-kind-icon">sort</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#sync" class="tsd-kind-icon">sync</a></li>
								...
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="url.urlrouter.html#when" class="tsd-kind-icon">when</a></li>
							</ul>
						</section>
					</div>
				</section>
    ...
    -->
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L62">core/src/url/urlRouter.ts:62</a></li>
						</ul>
					</aside>
				</section>
			</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								Once the initialization is complete, call <a href="url.urlrouter.html#listen">listen</a> to tell UI-Router to start watching and synchronizing the URL.</p>
								<h4 id="example-">Example:</h4>
								<pre><code class="lang-js"><span class="hljs-comment">// Prevent $urlRouter from automatically intercepting URL changes when it starts;</span>
urlService.deferIntercept();

$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  resp.data.forEach(<span class="hljs-function"><span class="hljs-params">state</span> =&gt;</span> $stateRegistry.register(state));
  urlService.listen();
  urlService.sync();
});
</code></pre>
							...
							<hr>
							<aside class="tsd-sources">
								<p>Implementation of <a href="../interfaces/url.urlsyncapi.html">UrlSyncApi</a>.<a href="../interfaces/url.urlsyncapi.html#deferintercept">deferIntercept</a></p>
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L301">core/src/url/urlRouter.ts:301</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L82">core/src/url/urlRouter.ts:82</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-private tsd-is-external">
					<a name="ensuresorted" class="tsd-anchor"></a>
					<!--
        <h3><span class="tsd-flag ts-flagPrivate">Private</span> ensure<wbr>Sorted</h3>
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-private tsd-is-external">
						<li class="tsd-signature tsd-kind-icon">ensure<wbr>Sorted<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-returns">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L94">core/src/url/urlRouter.ts:94</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<h4 id="example-">Example:</h4>
								<pre><code class="lang-js">matcher = $umf.compile(<span class="hljs-string">"/about/:person"</span>);
params = { <span class="hljs-attr">person</span>: <span class="hljs-string">"bob"</span> };
$bob = $urlRouter.href(matcher, params);
<span class="hljs-comment">// $bob == "/about/bob";</span>
</code></pre>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L216">core/src/url/urlRouter.ts:216</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L283">core/src/url/urlRouter.ts:283</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<p>Call this sometime after calling <a href="url.urlrouter.html#deferintercept">deferIntercept</a> to start monitoring the url.
								This causes <a href="url.urlrouter.html">UrlRouter</a> to start listening for changes to the URL, if it wasn&#39;t already listening.</p>
								<p>If called with <code>false</code>, will stop listening.  Call listen() again to start listening</p>
								<h4 id="example-">Example:</h4>
								<pre><code class="lang-js">urlService.deferIntercept();
...
$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  ...
  urlService.sync();
							...
							<hr>
							<aside class="tsd-sources">
								<p>Implementation of <a href="../interfaces/url.urlsyncapi.html">UrlSyncApi</a>.<a href="../interfaces/url.urlsyncapi.html#listen">listen</a></p>
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L158">core/src/url/urlRouter.ts:158</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
						...
						<li class="tsd-header">
							<p> Given a URL, check all rules and return the best <a href="../interfaces/url.matchresult.html">MatchResult</a> </p>
						</li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L103">core/src/url/urlRouter.ts:103</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<ul>
									<li>If <code>handler</code> is a function, the function receives the current url (<a href="../interfaces/url.urlparts.html">UrlParts</a>) and the <a href="core.uirouter.html">UIRouter</a> object.
  ...
  <span class="hljs-keyword">return</span> { <span class="hljs-attr">state</span>: <span class="hljs-string">'home'</span> };
							...
							<hr>
							<aside class="tsd-sources">
								<p>Implementation of <a href="../interfaces/url.urlrulesapi.html">UrlRulesApi</a>.<a href="../interfaces/url.urlrulesapi.html#otherwise">otherwise</a></p>
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L275">core/src/url/urlRouter.ts:275</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
						...
						<li class="tsd-description">
							...
							<ul class="tsd-parameters">
								...
								<li>
									...
									<ul class="tsd-parameters">
										<li class="tsd-parameter">
											<h5><span class="tsd-flag ts-flagOptional">Optional</span> replace<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">true</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">false</span></h5>
										</li>
									</ul>
								</li>
							</ul>
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L192">core/src/url/urlRouter.ts:192</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
						<li class="tsd-signature tsd-kind-icon">remove<wbr>Rule<span class="tsd-signature-symbol">(</span>rule<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
							...
							<ul class="tsd-parameters">
								<li>
									<h5>rule <span class="tsd-signature-type">any</span></h5>
								</li>
							</ul>
							<div class="tsd-returns">
								<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L264">core/src/url/urlRouter.ts:264</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<p>Usually, a url rule is added using <a href="../interfaces/state.statedeclaration.html#url">StateDeclaration.url</a> or <a href="url.urlrouter.html#when">when</a>.
									This api can be used directly for more control (to register a <a href="url.baseurlrule.html">BaseUrlRule</a>, for example).
								Rules can be created using <a href="url.urlrouter.html#urlrulefactory">UrlRouter.urlRuleFactory</a>, or create manually as simple objects.</p>
								<p>A rule should have a <code>match</code> function which returns truthy if the rule matched.
								It should also have a <code>handler</code> function which is invoked if the rule is the best match.</p>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
								<li>
							...
							<hr>
							<aside class="tsd-sources">
								<p>Implementation of <a href="../interfaces/url.urlrulesapi.html">UrlRulesApi</a>.<a href="../interfaces/url.urlrulesapi.html#rule">rule</a></p>
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L252">core/src/url/urlRouter.ts:252</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
						<li class="tsd-signature tsd-kind-icon">rules<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/url.urlrule.html" class="tsd-signature-type">UrlRule</a><span class="tsd-signature-symbol">[]</span></li>
						<li class="tsd-header">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<div class="tsd-returns">
								<h4 class="tsd-returns-title">Returns <a href="../interfaces/url.urlrule.html" class="tsd-signature-type">UrlRule</a><span class="tsd-signature-symbol">[]</span></h4>
								: <p>an array of all the registered rules</p>
							</div>
							<hr>
							<aside class="tsd-sources">
								<p>Implementation of <a href="../interfaces/url.urlrulesapi.html">UrlRulesApi</a>.<a href="../interfaces/url.urlrulesapi.html#rules">rules</a></p>
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L269">core/src/url/urlRouter.ts:269</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L89">core/src/url/urlRouter.ts:89</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
						...
						<li class="tsd-header">
							<p> Checks the URL for a matching <a href="../interfaces/url.urlrule.html">UrlRule</a> </p>
						</li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<p>Checks the current URL for a matching url rule, then invokes that rule&#39;s handler.
								This method is called internally any time the URL has changed.</p>
								<p>This effectively activates the state which matches the current URL.</p>
								<h4 id="example-">Example:</h4>
								<pre><code class="lang-js">urlService.deferIntercept();
...
$http.get(<span class="hljs-string">'/states.json'</span>).then(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">resp</span>) </span>{
  ...
  urlService.sync();
							...
							<hr>
							<aside class="tsd-sources">
								<p>Implementation of <a href="../interfaces/url.urlsyncapi.html">UrlSyncApi</a>.<a href="../interfaces/url.urlsyncapi.html#sync">sync</a></p>
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L135">core/src/url/urlRouter.ts:135</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L171">core/src/url/urlRouter.ts:171</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<ul class="tsd-parameters">
								<li>
									<h5>matcher <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">RegExp</span><span class="tsd-signature-symbol"> | </span><a href="url.urlmatcher.html" class="tsd-signature-type">UrlMatcher</a></h5>
								</li>
								<li>
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlRouter.ts#L293">core/src/url/urlRouter.ts:293</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
				...
				<ul class="current">
					<li class="current tsd-kind-class tsd-parent-kind-external-module tsd-is-external">
						...
						<ul>
							...
							<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
								<a href="url.urlrouter.html#dispose" class="tsd-kind-icon">dispose</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-private tsd-is-external">
								<a href="url.urlrouter.html#ensuresorted" class="tsd-kind-icon">ensure<wbr>Sorted</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
