...
<div class="container container-main">
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					...
					the matched parameters returned by <a href="url.urlmatcher.html#exec">UrlMatcher.exec</a>.</p>
					<ul>
					...
					<p>Note: a RegExp parameter will encode its value using either <a href="params.paramtypes.html#path">ParamTypes.path</a> or <a href="params.paramtypes.html#query">ParamTypes.query</a>.</p>
					<ul>
						<li><p><em>Custom parameter types</em> may also be specified after a colon (<code>/somePath/{param:int}</code>) in curly brace parameters.
							See <a href="url.urlmatcherfactory.html#type">UrlMatcherFactory.type</a> for more information.</p>
						</li>
					...
					<div class="tsd-index-content">
						...
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								...
								<li class="tsd-kind-method tsd-parent-kind-class tsd-is-static"><a href="url.urlmatcher.html#compare" class="tsd-kind-icon">compare</a></li>
							</ul>
						</section>
					</div>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class">
						<li class="tsd-signature tsd-kind-icon">new <wbr>Url<wbr>Matcher<span class="tsd-signature-symbol">(</span>pattern<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, paramTypes<span class="tsd-signature-symbol">: </span><a href="params.paramtypes.html" class="tsd-signature-type">ParamTypes</a>, paramFactory<span class="tsd-signature-symbol">: </span><a href="../interfaces/url.paramfactory.html" class="tsd-signature-type">ParamFactory</a>, config<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="url.urlmatcher.html" class="tsd-signature-type">UrlMatcher</a></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<ul class="tsd-parameters">
								...
								<li>
									<h5>paramTypes <a href="params.paramtypes.html" class="tsd-signature-type">ParamTypes</a></h5>
									:         <div class="tsd-comment tsd-typography">
										<div class="lead">
											<p>The <a href="params.paramtypes.html">ParamTypes</a> registry</p>
										</div>
									</div>
								</li>
								<li>
								...
								<li>
									<h5>config: <span class="tsd-flag ts-flagOptional">Optional</span>&nbsp; <span class="tsd-signature-type">any</span></h5>
									:         <div class="tsd-comment tsd-typography">
										<div class="lead">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlMatcher.ts#L118">core/src/url/urlMatcher.ts:118</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<div class="tsd-signature tsd-kind-icon">config<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">any</span>    <div class="tsd-header">
							<p> A configuration object</p>
							<ul>
								<li><code>caseInsensitive</code> - <code>true</code> if URL matching should be case insensitive, otherwise <code>false</code>, the default value (for backward compatibility) is <code>false</code>.</li>
								<li><code>strict</code> - <code>false</code> if matching against a URL with a trailing slash should be treated as equivalent to a URL without a trailing slash, the default value is <code>true</code>.</li>
					...
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlMatcher.ts#L127">core/src/url/urlMatcher.ts:127</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class">
        ...
        <h3>pattern</h3>
    -->
					<div class="tsd-signature tsd-kind-icon">pattern<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span>    <div class="tsd-header">
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlMatcher.ts#L223">core/src/url/urlMatcher.ts:223</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
						<li class="tsd-signature tsd-kind-icon">exec<span class="tsd-signature-symbol">(</span>path<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, search<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">any</span>, hash<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">string</span>, options<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/params.rawparams.html" class="tsd-signature-type">RawParams</a></li>
						<li class="tsd-header">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<pre><code class="lang-js"><span class="hljs-keyword">new</span> UrlMatcher(<span class="hljs-string">'/user/{id}?q&amp;r'</span>).exec(<span class="hljs-string">'/user/bob'</span>, {
  <span class="hljs-attr">x</span>: <span class="hljs-string">'1'</span>, <span class="hljs-attr">q</span>: <span class="hljs-string">'hello'</span>
});
<span class="hljs-comment">// returns { id: 'bob', q: 'hello', r: null }</span>
</code></pre>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlMatcher.ts#L269">core/src/url/urlMatcher.ts:269</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
						<li class="tsd-signature tsd-kind-icon">format<span class="tsd-signature-symbol">(</span>values<span class="tsd-signature-symbol">?: </span><a href="../interfaces/params.rawparams.html" class="tsd-signature-type">RawParams</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
						<li class="tsd-header">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							<div class="tsd-comment tsd-typography">
								...
								<h4 id="example-">Example:</h4>
								<pre><code class="lang-js"><span class="hljs-keyword">new</span> UrlMatcher(<span class="hljs-string">'/user/{id}?q'</span>).format({ <span class="hljs-attr">id</span>:<span class="hljs-string">'bob'</span>, <span class="hljs-attr">q</span>:<span class="hljs-string">'yes'</span> });
<span class="hljs-comment">// returns '/user/bob?q=yes'</span>
</code></pre>
							</div>
							<h4 class="tsd-parameters-title">Parameters</h4>
							<ul class="tsd-parameters">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlMatcher.ts#L393">core/src/url/urlMatcher.ts:393</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlMatcher.ts#L239">core/src/url/urlMatcher.ts:239</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
						<li class="tsd-signature tsd-kind-icon">validates<span class="tsd-signature-symbol">(</span>params<span class="tsd-signature-symbol">: </span><a href="../interfaces/params.rawparams.html" class="tsd-signature-type">RawParams</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
						<li class="tsd-header">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlMatcher.ts#L367">core/src/url/urlMatcher.ts:367</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
    ...
    -->
					<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-static">
						<li class="tsd-signature tsd-kind-icon">compare<span class="tsd-signature-symbol">(</span>a<span class="tsd-signature-symbol">: </span><a href="url.urlmatcher.html" class="tsd-signature-type">UrlMatcher</a>, b<span class="tsd-signature-symbol">: </span><a href="url.urlmatcher.html" class="tsd-signature-type">UrlMatcher</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></li>
						<li class="tsd-header">
					...
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<ul class="tsd-parameters">
								<li>
									<h5>a <a href="url.urlmatcher.html" class="tsd-signature-type">UrlMatcher</a></h5>
								</li>
								<li>
									<h5>b <a href="url.urlmatcher.html" class="tsd-signature-type">UrlMatcher</a></h5>
								</li>
							</ul>
							<div class="tsd-returns">
							...
							<aside class="tsd-sources">
								<ul>
									<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/url/urlMatcher.ts#L495">core/src/url/urlMatcher.ts:495</a></li>
								</ul>
						</aside>        </li>
					</ul>
				</section>
					...
					<li class="current tsd-kind-class tsd-parent-kind-external-module">
						...
						<ul>
							...
							<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-static">
								<a href="url.urlmatcher.html#compare" class="tsd-kind-icon">compare</a>
							</li>
						</ul>
					</li>
				</ul>
