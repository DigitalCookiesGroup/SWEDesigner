...
<head>
	...
	<title>TransitionHookScope | @uirouter/angular</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="transition.transitionhookscope.html">TransitionHookScope</a>
				</li>
			</ul>
			<h1>Enumeration TransitionHookScope</h1>
		</div>
	</div>
</header>
<div class="container container-main">
	<div class="row">
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-enum-member tsd-parent-kind-enum"><a href="transition.transitionhookscope.html#state" class="tsd-kind-icon">STATE</a></li>
								<li class="tsd-kind-enum-member tsd-parent-kind-enum"><a href="transition.transitionhookscope.html#transition" class="tsd-kind-icon">TRANSITION</a></li>
							</ul>
						</section>
					</div>
				</section>
        ...
        <h3>STATE</h3>
    -->
					<div class="tsd-signature tsd-kind-icon">STATE<span class="tsd-signature-symbol">:</span> </div>
					<div class="tsd-declaration">
					</div>
					<aside class="tsd-sources">
						<ul>
							<li>Defined in <a href="https://github.com/ui-router/core/blob/c22f694/src/transition/interface.ts#L820">core/src/transition/interface.ts:820</a></li>
						</ul>
					</aside>
				</section>
				<section class="tsd-panel tsd-member tsd-kind-enum-member tsd-parent-kind-enum">
					...
					<li class="current tsd-kind-enum tsd-parent-kind-external-module">
						...
						<ul>
							<li class=" tsd-kind-enum-member tsd-parent-kind-enum">
								<a href="transition.transitionhookscope.html#state" class="tsd-kind-icon">STATE</a>
							</li>
							<li class=" tsd-kind-enum-member tsd-parent-kind-enum">
								<a href="transition.transitionhookscope.html#transition" class="tsd-kind-icon">TRANSITION</a>
							</li>
						</ul>
					</li>
				</ul>
